...
class AddTeamMembersTableViewController: UITableViewController, UISearchResultsUpdating, UISearchBarDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.resultsController.view.tintColor = UIColor.blue
        self.searchController.view.tintColor = UIColor.blue
        ...
        self.resultsController.view.backgroundColor = UIColor.white
